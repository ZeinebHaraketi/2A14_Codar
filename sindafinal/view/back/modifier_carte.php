...
include_once 'C:/xampp/htdocs/sindafinal/Model/carte.php';
                      ...
                      <h1 style="color:#000000">****************************Veuillez choisir vos nouvaux donées********************************</h1>
                           ...
                           <tr> <td>    <p style="color:black;font-size:18px;">identifient :</p> </td>
                               ...
                               <tr> <td> <p style="color:black;font-size:18px;">Nouveau nom :</p> </td>
                                ...
                                <div class="form-group">
                                <tr> <td> <p style="color:black;font-size:18px;">Nouveau type du carte  : </p></td>
                                <td>   <input type="text" style="background-color:purple;color:white;width:150px;"  class="form-control" name="typecarte" rows="10" id="typecarte" value="<?php echo $user['typecarte']; ?>" ></td>
                                </tr> </div>
