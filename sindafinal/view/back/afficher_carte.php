<?php
include "C:/xampp/htdocs/sindafinal/Controller/carteC.php";
$carte=new carteC();
$listecarte=$carte->affichercarte();
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../back/ajouter_offre.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ajouter offre</p>
                </a>
              </li>
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../back/afficher_offre.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>table des offres</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../back/afficher_carte.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>tables des cartes</p>
                </a>
              </li>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Afficher carte </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
           ...
           <td> <?php echo $row['typecarte'];?></td>
					 <td> <?php echo $row['tel'];?></td>
                     
                     <td> 
                     <form method="POST" action="../back/supprimer_carte.php">
                                        <button type="submit"  id="supprimer"  class="btn btn-danger">supprimer</button>
                                        <input type="hidden" value=<?PHP echo $row['idc']; ?> name="idc">
                                        </form>
                                        
                      
                                       <a class="btn btn-primary" href="modifier_carte.php?idc=<?PHP echo $row['idc']; ?>">Modifier </a>
