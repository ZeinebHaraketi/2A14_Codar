...
$resto=new restoC();
$listeresto=$resto->afficherresto();
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Afficher resto </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                 ...
                 <a href="ajouter_resto.php" class="btn btn-primary" style="float:right;">Add New Record</a>
                  ...
                  <tr>
					...
					<td> <?php echo $row['email'];?></td>
                     ...
                     <td> 
                     <form method="POST" action="../back/supprimer_resto.php">
                                        <button type="submit"  id="supprimer"  class="btn btn-danger">supprimer</button>
                                        <input type="hidden" value=<?PHP echo $row['id']; ?> name="id">
                                        </form>
                                        
                      
                                       <a class="btn btn-primary" href="modifier_resto.php?id=<?PHP echo $row['id']; ?>">Modifier </a>
