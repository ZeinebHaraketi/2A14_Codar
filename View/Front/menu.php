...
<html lang="en">
  ...
  <head>
    ...
    <link rel="icon" href="../Front/assets/images/Fagito.ico">
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="../Front/index.html"><h2>Fagito <img src="../assets/Fagito.png" width="50" height="50"/></h2>  </a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link " href="../Front/index.html">Home 
                      <span class="sr-only">(current)</span>
					  
                    </a>
                </li> 

                <li class="nav-item"><a class="nav-link" href="../Front/book-table.html">Nos Offres</a></li>

                <li class="nav-item active"><a class="nav-link" href="../Front/menu.php">Nos Produits</a></li>

                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">More</a>
                    
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="../Front/about-us.html">About Us</a>
                      <a class="dropdown-item" href="../Front/blog.html">Blog</a>
                      <a class="dropdown-item" href="../Front/testimonials.html">Testimonials</a>
                    </div>
                </li>
                
                <li class="nav-item"><a class="nav-link" href="../Front/contact.html">Connexion</a></li>
            </ul>
          </div>
        </div>
      </nav>
