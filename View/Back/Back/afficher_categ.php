            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
					...
					<td> <?php echo $row['descriptionc'];?></td>
                     ...
                     <td> 
                     <form method="POST" action="../../View/Back/supprimer_categ.php">
			   ...
			   window.location.reload();
				...
				<form method="POST" action="../../View/Back/linechart/stat_c.php">
                                        
										<button type="submit"  id="statistique"  class="btn btn-info" href="../../View/Back/linechart/stat_c.php"> <i class="far fa-chart-bar"></i></button>
