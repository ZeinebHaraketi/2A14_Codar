  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
		...
		<a class="btn btn-danger" href="../View/pdf_produit.php"><i class="far fa-file-pdf"></i> </a>
		...
		<form method="POST" action="../View/linechart/stat.php">
                                        
										<button type="submit"  id="statistique"  class="btn btn-info" href="../View/linechart/stat.php"> <i class="far fa-chart-bar"></i></button>
