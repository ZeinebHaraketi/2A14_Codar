...
//$listecommentaire=$commentaire->affichercommentaire();
...
<head>
  ...
  <title> Gestion de commentaires</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">MOHAMED AMINE ZARGA </a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/CRUD/zarga/back/Admin/AjouterBlog.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <a href="../back/afficher_commentaire.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>table des commentaires</p>
              ...
              <li class="nav-item">
                ...
                <a href="../back/afficher_blog.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>table des blogs</p>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Gestion de Commentaire </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Gestion commentaires</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="ajouter_commentaire.php" method="POST" enctype="multipart/form-data" name="myform">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Nom</label>
                    <input class="form-control" name="NomC" id="NomC" placeholder="Username" required >
                  </div>
				   ...
				   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="messageC" id="messageC" placeholder="Votre commentaire" required>
                  </div>
