        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../View/ajouter_blog.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ajouter Blog</p>
                </a>
              </li>
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/CRUD/Zarga/back/afficher_blog.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Mes Tables</p>
                </a>
              </li>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <!--
                  <h2>View Records
                 <a href="ajouter_blog.php" class="btn btn-primary" style="float:right;">Add New Record</a>
                  </h2>
                  --> 
				  <?php
...
<tr>
          ...
          <td> <?php echo $row['ImageB'];?></td>
                     ...
                     <td> 
                     <form method="POST" action="supprimer_blog.php">
...
<td > <button onclick="ExportToExcel(example1)">Export</button>  </td>
				...
				<a class="btn btn-success" href="trier_blog.php?idB=<?PHP echo $row['TitreB']; ?>">Trier </a>
				<a class="btn btn-primary" href="afficher_blog.php?id_produit=<?PHP echo $row['nom_produit']; ?>">Retour </a>
