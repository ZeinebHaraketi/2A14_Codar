        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/CRUD/Zarga/back/Admin/AjouterBlog.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ajouter blog</p>
                </a>
              </li>
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../back/afficher_commentaire.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>table des commentaire</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../back/afficher_blog.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>tables des blogs</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Afficheage des Blog </h3>
              ...
              <div class="card-body">
			   ...
			   window.location.reload();}</script>
				  ...
				  <a class="btn btn-success" href="trier_blog.php"><i class="fas fa-sort"></i> </a>
                  ...
                  <!--
                  <h2>View Records
                 <a href="/CRUD/Zarga/back/Admin/AjouterBlog.php" class="btn btn-primary" style="float:right;">Add New Record</a>
                  </h2>
                  --> 
                  ...
                  <tr>
					...
					<td> <?php echo $row['TitreB'];?></td>
					<td> <?php echo $row['DescriptionB'];?></td>
      <!--    <td><?PHP echo "<img  src='/CRUD/zarga/back/Admin/".$row['ImageB']. "' >"; ?> </td>  -->
      ...
      <td> <?PHP echo '<img src="/CRUD/zarga/back/Admin/'.$row['ImageB'].'" width="200" height="200" />'; ;?>  </td>
                     ...
                     <td> 
                     <form method="POST" action="../back/supprimer_blog.php">
                                        <button type="submit"  id="supprimer"  class="btn btn-danger">supprimer</button>
                                        <input type="hidden" value=<?PHP echo $row['idB']; ?> name="idB">
                                        </form>
                                        
                      
                                       <a class="btn btn-primary" href="modifier_blog.php?idB=<?PHP echo $row['idB']; ?>">Modifier </a>
                                     
                     </td>

         <!--              <td> 

                     <a class="btn btn-primary" href="acceder.php?idB=<?PHP echo $row['idB']; ?>">ACCEDER </a>
                                     
                     </td>
 -->

                     <script type="text/javascript">
function ExportToExcel(example1){
...
<td > <button onclick="ExportToExcel(example1)">Export</button>  </td>
                   </tr> 
                   <?PHP
				      }
		  	         ?>
