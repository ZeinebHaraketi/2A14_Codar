...
<head>
    ...
    <title> CarePoint Admin </title>
    <script src="https://cdn.tiny.cloud/1/lhwhsl4nookzdmeq2gs77qyptoptqs097pvdbtet1ytznzbs/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="POST" action="mdfEvent.php" id="demo-form2" enctype="multipart/form-data" class="form-horizontal form-label-left">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" value="<?php echo $nom; ?>" name="nom" required="required" class="form-control " >
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="file" value ="<?php echo $image; ?>" id="fileToUpload" class="form-control" name="fileToUpload">
                        </div>
                      </div>
                      <div class="x_content">
