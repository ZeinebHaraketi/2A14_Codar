		...
		<form action="" method="POST">
            <table align="center">
                <tr>
                    ...
                    <td>
                        <label for="nomutilisateur">nomutilisateur:
                        </label>
                    </td>
                ...
                <tr>
                    <td>
                        <label for="prenomutilisateur">prenomutilisateur:
                        </label>
                    </td>
				    ...
				    <tr>
                    <td>
                        <label for="eadresseutilisateur">eadresseutilisateur:
                        </label>
                    </td>
                    <td>
				...
				<tr>
                    <td>
                        <label for="dateutilisateur">dateutilisateur:
                        </label>
                    </td>
                    <td>
				...
				<tr>
                    <td>
                        <label for="loginutilisateur">loginutilisateur:
                        </label>
                    </td>
                    <td>
				...
				<tr>
                    <td>
                        <label for="mdputilisateur">mdputilisateur:
                        </label>
                    </td>
                    <td>
                        <input type="text" name="mdputilisateur" id="mdputilisateur"  value = "<?php echo $utilisateur['mdputilisateur']; ?>">
                    </td>
                </tr>
