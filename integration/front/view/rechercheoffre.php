<?php
 ...
 $carteC = new carteC();
  $cartes = $carteC->affichercarte();
  if(isset($_POST['carte']) && isset($_POST['search'])) {$list=$carteC->afficheroffres($_POST['carte']);}
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="book-table.html">livraison</a></li>

                <li class="nav-item"><a class="nav-link" href="menu.html">Menu</a></li>

                <li class="nav-item dropdown active">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">offre</a>
                    
                    <div class="dropdown-menu">
                    
                      <a class="dropdown-item active" href="Afficheoffre.php">Offre</a>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4>trouver les meilleures offres </h4>
              <h2>Offre</h2>
            </div>
          </div>
        </div>
...
<?php if(isset($_POST['search'])) { ?>
    <section class="container">
        ...
        <div class="shop-items">
            <?php foreach($cartes as $offre) { ?>

         <label>heeeeeeeeeeeeeeeey </label>
          <strong class="shop-item"> <?=$offre['datedeb']?> </strong> 
