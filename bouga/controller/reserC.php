...
require_once 'C:/xampp/htdocs/bouga/model/reser.php' ;
 ...
 function recherchereser($search_value)
 {
     $sql="SELECT * FROM reser where idr like '$search_value' or nom like '$search_value' or dat like '%$search_value%' or nbp like '%$search_value%' or nresto like '%$search_value%' or email like '%$search_value%'  ";
