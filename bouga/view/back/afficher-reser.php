...
$reser=new reserC();
$listereser=$reser->afficherreser();
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeback" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeback">
              ...
              <li class="nav-item">
                <a href="../back/ajouter_resto.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ajouter reser</p>
                </a>
              </li>
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeback">
              ...
              <li class="nav-item">
                <a href="../assets/afficher_resto.html" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Mes Tables</p>
                </a>
              </li>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Afficher reser </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <!--
                  <h2>back Records
                 <a href="ajouter_resto.php" class="btn btn-primary" style="float:right;">Add New Record</a>
                  </h2>
                  --> 
				  <?php
                  ...
                  <tr>
					...
					<td> <?php echo $row['email'];?></td>
                     ...
                     <td> 
                     <form method="POST" action="../back/supprimer_reser.php">
                                        <button type="submit"  id="supprimer"  class="btn btn-danger">supprimer</button>
                                        <input type="hidden" value=<?PHP echo $row['idr']; ?> name="idr">
                                        </form>
                                        
                      
                                       <a class="btn btn-primary" href="modifier_reser.php?id=<?PHP echo $row['idr']; ?>">Modifier </a>
                                        <div>
				  
				                               <a class="btn btn-success" href="trier_reser.php"><i class="fas fa-sort"></i> </a>
