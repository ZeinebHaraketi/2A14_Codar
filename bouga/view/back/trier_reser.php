        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../View/ajouter_reser.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ajouter reser</p>
                </a>
              </li>
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../View/afficher_reser.php" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Gestion reser</p>
                </a>
              </li>
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <tr>
					...
					<td> <?php echo $row['nbp'];?></td>
                     ...
                     <form method="POST" action="../View/supprimer_reser.php">
                                       ...
                                       <a class="btn btn-primary" href="MODIF_P.php?idr=<?PHP echo $row['idr']; ?>">Modifier </a>
                ...
                <div>
				<a class="btn btn-success" href="trier_reser.php?idr=<?PHP echo $row['nom']; ?>"><i class="fas fa-sort"></i></a>
