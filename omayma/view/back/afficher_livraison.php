...
$listelivraison=$livraison->afficherlivraison();
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeback" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeback">
              ...
              <li class="nav-item">
                <a href="../back/ajouter_livraison.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeback">
              ...
              <li class="nav-item">
                <a href="../assets/afficher_livraison.html" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Mes Tables</p>
                </a>
              </li>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Afficher livraison </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <!--
                  <h2>back Records
                 <a href="ajouter_livraison.php" class="btn btn-primary" style="float:right;">Add New Record</a>
                  </h2>
                  --> 
				  <?php
           ...
           <td> <?php echo $row['mail'];?></td>
                     ...
                     <td> 
                     <form method="POST" action="../back/supprimer_livraison.php">
                                        <button type="submit"  id="supprimer"  class="btn btn-danger">supprimer</button>
                                        <input type="hidden" value=<?PHP echo $row['id']; ?> name="id">
                                        </form>
                                        
                      
                                       <a class="btn btn-primary" href="modifier_livraison.php?id=<?PHP echo $row['id']; ?>">Modifier </a>
