...
<head>
  ...
  <title> Gestion de livraisons</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../assets/forms/ajouter_livraison.html" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../assets/forms/modifier_livraison.html" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <a href="../View/afficher_livraison.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Mes Tables</p>
