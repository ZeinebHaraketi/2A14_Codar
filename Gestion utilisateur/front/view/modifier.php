		...
		<form action="" method="POST">
            <table align="center">
                <tr>
                    ...
                    <td><input type="text" name="nomutilisateur" id="nomutilisateur" maxlength="20" value = "<?php echo $utilisateur['nomutilisateur']; ?>" disabled> </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="prenomutilisateur" id="prenomutilisateur" maxlength="20" value = "<?php echo $utilisateur['prenomutilisateur']; ?>"disabled></td>
                </tr>
				    <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="eadresseutilisateur" id="eadresseutilisateur"  value = "<?php echo $utilisateur['eadresseutilisateur']; ?>"disabled>
                    </td>
                </tr>
				...
				<tr>
                    ...
                    <td>
                        <input type="date" name="dateutilisateur" id="dateutilisateur"  value = "<?php echo $utilisateur['dateutilisateur']; ?>"disabled>
                    </td>
                </tr>
