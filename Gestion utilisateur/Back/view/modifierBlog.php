  ...
  if(isset($_GET["idB"]))
{
  ...
  if(!empty($idB)&& is_numeric($idB))
  {
    ...
    $TitreB=$data[0]["TitreB"];
    $DescriptionB=$data[0]["DescriptionB"];
    $ImageB=$data[0]["ImageB"];
    $idB=$data[0]["idB"];
  }
}
?>
...
<head>
    ...
    <title>Z4RGA Admin </title>
    <script src="https://cdn.tiny.cloud/1/g08d37xx90t7l5ifub5okda1vhw70vfw43o4gmso90dsdp18/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Aurora Team!</span></a>
            </div>
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="POST" action="mdfBlog.php" id="demo-form2" enctype="multipart/form-data" class="form-horizontal form-label-left">
                       <input type="text"  name="idB" value="<?php echo $idB; ?>"  hidden>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="file" value ="<?php echo $ImageB; ?>" id="fileToUpload" class="form-control" name="fileToUpload">
                        </div>
                      </div>
                      <div class="x_content">
