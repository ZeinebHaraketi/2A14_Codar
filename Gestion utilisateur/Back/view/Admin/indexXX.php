        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title" > <span>Aurora Team !</span></a>
            </div>
          ...
          <div class="nav_menu">
              ...
              <ul class=" navbar-right">
                ...
                <li  class="nav-item dropdown open">
                  <a type="button"   class="dropdown-toggle info-number" data-toggle="dropdown"
                    ...
                    <div id="navbarsExampleDefault" >
                      <li class="nav-item">
                        <a class="dropdown-item"  aria-haspopup="true" aria-expanded="false">
