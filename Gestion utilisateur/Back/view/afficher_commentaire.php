  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="afficherutilisateur.php" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../back/ajouter_commentaire.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/CRUD/Zarga/back/Admin/gestionBlogs.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Afficher commentaire </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <!--
                  <h2>View Records
                 <a href="ajouter_commentaire.php" class="btn btn-primary" style="float:right;">Add New Record</a>
                  </h2>
                  --> 
				  <?php
                  ...
                  <tr>
                    ...
                    <td> <?php echo $row['NomC'];?></td>
				          	<td> <?php echo $row['messageC'];?></td>
                    
					
                     
                     <td> 
                     <form method="POST" action="../back/supprimer_commentaire.php">
                                        <button type="submit"  id="supprimer"  class="btn btn-danger">supprimer</button>
                                        <input type="hidden" value=<?PHP echo $row['idC']; ?> name="idC">
                                        </form>
                                        
                      
                                       <a class="btn btn-primary" href="modifier_commentaire.php?idC=<?PHP echo $row['idC']; ?>">Modifier </a>
